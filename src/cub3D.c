...
/*   Updated: 2022/05/03 12:59:27 by xxxxxxx          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_cub(t_cub *cub)
{
	...
	cub->nb_walls = 0;
	cub->check_null = 0;
	cub->no_text = ft_calloc(1, sizeof (t_text));
	cub->so_text = ft_calloc(1, sizeof (t_text));
	cub->ea_text = ft_calloc(1, sizeof (t_text));
	cub->we_text = ft_calloc(1, sizeof (t_text));
